        ...
        <section class="card-list items-center justify-center ">
          <article class="card">
            ...
            <div class="card-author">
              ...
              <div class="author-name">
                <div class="author-name-prefix text-white text-xl font-extrabold">Clinical Training</div>
                PSup
              </div>
            </div>
          ...
          <article class="card">
            ...
            <div class="card-author">
              ...
              <div class="author-name">
                <div class="author-name-prefix text-white text-xl font-extrabold">Counseling Training</div>
                IDEATHON-2024
              </div>
            </div>
          </article>
          ...
          <article class="card">
            ...
            <div class="card-author">
              ...
              <div class="author-name">
                <div class="author-name-prefix text-white text-xl font-extrabold">Art-Therapy Training </div>
                KISAAN24
              </div>
            </div>
          </article>
          ...
          <article class="card">
            ...
            <div class="card-author">
              ...
              <div class="author-name">
                <div class="author-name-prefix text-white text-xl font-extrabold">Psychometric Testing</div>
                INTERNSHALA
              </div>
            </div>
          </article>
          <article class="card">
            ...
            <div class="card-author">
              ...
              <div class="author-name">
                <div className=" text-white text-xl font-extrabold">Therapies Training</div>
                Brainstreamlinear
              </div>
            </div>
          </article>
