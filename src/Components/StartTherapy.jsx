    ...
    <div className="w-screen h-screen bg-white">
      <div className="flex flex-col items-center">
        ...
        <div className='flex w-3/4 gap-7 mt-20 text-white text-[30px] font-extrabold justify-between  px-20'>
          <div className='w-5/12 h-56 bg-[#FFC7ED] rounded-md transform transition-transform hover:scale-105  p-2 shadow-2xl pt-5'>
              
              <div className='flex items-center justify-center'>
              In-Person Consultation
              </div>
              <div className='flex justify-between  mx-8 items-end'>
                <button className='  px-2 w-5/12 h-fit border-2 border-white rounded-md text-xl 
                transform transition-transform hover:scale-105'>
                    Book Now
                </button>
              <Icon icon={WorkShop} className="w-24 h-24 text-white" size="large">
            {/* IMAGE */}
          </Icon>
              </div>
           </div>
          <div className='w-5/12 h-56 bg-[#7D8ABC] rounded-md transform transition-transform hover:scale-105 p-2 shadow-2xl pt-5'>
          ...
          <div className=' flex items-center justify-center'>
              ...
              <Icon icon={SmartClass} className="w-32 h-24 text-white" size="large">
            {/* IMAGE */}
          </Icon>
          </div>
          </div>
