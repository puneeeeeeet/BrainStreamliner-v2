...
import nature2 from '../assets/nature_flo.mp4'

const HowDiff = () => {
  return (
    <div className='w-screen h-full sm:h-fit '>
        ...
        <div className='w-7/12 text-center mt-20 text-xl font-semibold hidden sm:flex'>
        ...
        <video src={nature} autoPlay muted loop className='sm:w-screen sm:h-1/2 hidden sm:flex'/>
        <video src={nature2} autoPlay muted loop className='w-screen h-full flex sm:hidden'/>
