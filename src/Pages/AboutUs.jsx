...
const AboutUs = () => {
  ...
  return (
    <div className="w-full h-full">
      ...
      {/* First Section */}
      <div className="flex flex-col sm:flex-row justify-center items-center py-4 mb-10">
        <div className='flex flex-col items-center justify-center '>
        <div className="w-72 mx-10 h-80 flex-col flex items-center justify-center ">
          <img src={tamana} className="h-64 w-60"></img>
          <a
            href="https://www.linkedin.com/in/puneet-chhabra-3089b621b/"
            className="text-4xl  font-bold underline underline-offset-2 mt-5 "
          >
            Gayatri Ahuja
          </a>
          <p>
        ...
        <div className="w-10/12 sm:w-96 h-full  flex  justify-center py-4">
          <div className="">
            ...
            <p className="text-wrap text-justify   ">
              The idea for Brainstreamliner emerged from my personal journey as
              a psychology student and clinician. I often felt overwhelmed by
              the intricate theories and emotional challenges, seeking a more
              streamlined path to mental clarity. This pivotal experience
              inspired me to create a place where mental processes are
              simplified, making it easier for individuals and professionals to
              navigate their psychological journeys.
            </p>
            <p className="text-wrap text-justify   ">
          ...
          <div className="">
            ...
            <p className="text-wrap text-justify   ">
              <p className="flex gap-1">
                <p className="font-semibold w-30">Workshops:</p>Practical and
                engaging workshops designed to deepen understanding and develop
                essential psychological skills.
              </p>
              <p className="flex gap-1">
                <p className="font-semibold w-30">Counseling:</p>Personalized
                counseling sessions that focus on individual needs, promoting
                mental clarity and emotional health.
              </p>
              <p className="flex gap-1">
                <p className="font-semibold w-44">Clinical Trainings:</p>
                Specialized training in Art Therapy and Cognitive Behavioral
                Therapy (CBT) for therapists, equipping them with cutting-edge
                techniques.
              </p>
              <p className="flex gap-1">
                <p className="font-semibold w-30">Coaching:</p>Dedicated
                coaching for psychology students and professionals to help them
                excel in their academic and clinical endeavors.
              </p>
            </p>
          </div>
        </div>
